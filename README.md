...
### Workflow Features
- **Multi-version testing**: Tests against k3s versions 1.27, 1.28, and 1.29
- **Automated deployment**: Deploys Helm chart to k3s cluster
